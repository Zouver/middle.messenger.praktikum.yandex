...
export const informationsChangeDefault: KeyValueItem[] = [
	new KeyValueItem({
		key: "Почта",
		value: new Input({name: "email", value: "pochta@yandex.ru", type: "text"})
	}),
	new KeyValueItem({
		key: "Логин",
		value: new Input({name: "login", value: "ivanivanov", type: "text"})
	}),
	new KeyValueItem({
		key: "Имя",
		value: new Input({name: "first_name", value: "Иван", type: "text"})
	}),
	new KeyValueItem({
		key: "Фамилия",
		value: new Input({name: "second_name", value: "Иванов", type: "text"})
	}),
	new KeyValueItem({
		key: "Имя в чате",
		value: new Input({name: "display_name", value: "Иван", type: "text"})
	}),
	new KeyValueItem({
		key: "Телефон",
		value: new Input({name: "phone", value: "+7 (909) 967 30 30", type: "text"})
	}),
];
